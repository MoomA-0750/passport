...
許可を外せば登録も外れる。金庫の画面自体は対象から外している。

メニューまわりで効かせていること:

- メニューは **closed な Shadow DOM** の中に作る。ページ側の JS から中身を掴めないし、
  ページの CSS にも干渉されない
...
│   ├── content.js          # 入力欄のそばに出るメニュー（許可したサイトだけ）
